...
## :whale: 팀 소개
안녕하세요! 카카오 쇼핑 카테고리 분류 대회에 참가한 **S2Bstar** 팀입니다. 이번 대회에서 TEST 스코어로 3위(잠정 3위)를 했었지만, 입상 조건을 충족하지 못하여 최종 탈락하게되었습니다. 최종 결과가 조금 아쉬웠지만 팀원들과 정말 즐겁게 대회에 참여하고 많은 것을 배웠습니다. 저희는 자연어 처리에 대한 지식이 모두 전무한 상태로 시작했지만, **반복적인 데이터 분석**을 바탕으로 점수를 지속적으로 높여갔습니다. 이 글에서는 저희 팀의 수행과정, 시도했던 아이디어들 그리고 최종 탈락 이유에 대해서 다루어보려고 합니다.
